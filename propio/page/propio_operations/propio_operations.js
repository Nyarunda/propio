frappe.pages["propio-operations"].on_page_load = function (wrapper) {
  ...
  page.add_inner_button(__("Audit Desk Structure"), () => {
    runTask(__("Desk Structure Audit"), "propio.api.desk_setup.audit_role_center_structure");
  });

  page.add_inner_button(__("Apply Desk Structure"), () => {
    runTask(__("Apply Desk Structure"), "propio.api.desk_setup.apply_role_center_structure");
  });

  page.add_inner_button(__("Apply KPI Setup"), () => {
    runTask(__("Apply KPI Setup"), "propio.api.kpi_setup.ensure_number_cards_and_charts");
  });
